...
@bot.slash_command(name="addGlobal", description="Add the Global chat into this channel")
...
@bot.slash_command(name="servers", description="See Server using Global Chat")
